...
async function pertanyaan() {
  var { isConfirmed: prtanya } = await swals.fire({ title: 'Bae' + ' ' + tanya, text: '' + opstanya, imageUrl: '' + fotostiker6.src, showCancelButton: true, confirmButtonText: '' + tompositif, cancelButtonText: '' + tomnegatif, });
  if (prtanya) {
